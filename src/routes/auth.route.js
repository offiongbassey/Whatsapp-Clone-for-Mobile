...
import { changeProfileImage, getLoginStatus, login, logout, refreshToken, register, verify_signup } from "../controllers/auth.controller.js";
import { validationHandler } from "../helpers/validation.js";
import { get_login_status_validator, login_validator, profile_image_validator, signup_validator, verify_signup_validator } from "../middlewares/validator.js";
import authMiddleware from "../middlewares/authMiddleware.js";

const router = express.Router();

router.post("/register", validationHandler(signup_validator), register);
router.post("/verify-signup", validationHandler(verify_signup_validator), verify_signup);
